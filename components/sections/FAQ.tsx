...
export function FAQ() {
  ...
  return (
    <section className="relative w-full overflow-hidden bg-white dark:bg-[#050505] py-20 px-6 transition-colors duration-300">
      <div className="relative max-w-7xl mx-auto text-slate-900 dark:text-white">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          {/* Left Side - Heading and Description */}
          <div className="space-y-6">
            {/* Small Label */}
            <div className="inline-flex items-center gap-2 bg-blue-600 px-4 py-2 rounded-md text-white">
              <svg
                width="16"
                height="16"
                viewBox="0 0 16 16"
            ...
            <div className="space-y-2">
              ...
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-blue-600 dark:text-blue-400 leading-tight">
                questions
              </h2>
            </div>
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className={cn(
                  "rounded-lg border border-gray-200 bg-white p-5 cursor-pointer transition-all duration-300 shadow-sm dark:border-white/10 dark:bg-white/5",
                  openIndex === index ? "bg-gray-100 dark:bg-white/10" : "hover:bg-gray-50 dark:hover:bg-white/10"
                )}
              ...
              >
                ...
                <div
                  className={cn(
                    "text-sm md:text-base text-gray-600 dark:text-gray-300 transition-all duration-500 ease-in-out overflow-hidden",
                    openIndex === index
