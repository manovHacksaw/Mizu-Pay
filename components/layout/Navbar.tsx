...
export function Navbar() {
  return (
    <nav className="animate-nav fixed top-0 left-0 right-0 z-50 flex justify-center items-center px-8 md:px-72 py-4">
      <div className="flex items-center justify-between gap-4 md:gap-8 w-full max-w-7xl rounded-2xl px-4 md:px-6 py-3 bg-white/10 backdrop-blur-md border border-white/30 dark:border-gray-700/40 shadow-lg">
        {/* Left: Orange Dot */}
