    ...
    void mainImage( out vec4 fragColor, in vec2 fragCoord )
    {
      vec2 uv = (fragCoord.xy-.5*u_resolution.xy)/u_resolution.y;
        ...
        f = float(nbStep) / float(STEP);
         ...
         f *= .9;
         vec3 col = vec3(f * 0.2, f * 0.4, f * 0.8);
        ...
        >
            ...
            <div className="relative z-10 flex h-svh w-full items-center justify-center px-6">
                <div className="text-center">
                    ...
                    <p
                        ref={pRef}
                        className="mx-auto mt-4 max-w-2xl md:text-balance text-lg tracking-tight text-white/70 md:text-xl"
                    >
                        Mizu Pay lets you shop anywhere and pay with cUSD or CELO — turning every transaction into a force for good. Effortless, transparent, and climate-positive.
                    </p>
